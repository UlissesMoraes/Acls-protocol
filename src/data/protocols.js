...
export const P = [
  ...
  },
  {
    ...
    sub:"Urgência e emergência hipertensiva — AHA/ACC 2025 + literatura de terapia intensiva",
    cascade:[
      { step:1, phase:"AVALIAÇÃO INICIAL — PAS ≥ 180 ou PAD ≥ 120 mmHg", alert:false,
        ...
        decision:{ q:"Há sinais de lesão aguda de órgão-alvo (LOA)?", yes:"→ EMERGÊNCIA HIPERTENSIVA — tratamento IV imediato (Passo 3)", no:"→ URGÊNCIA HIPERTENSIVA — redução oral gradual (Passo 2)" }},
      { step:2, phase:"URGÊNCIA HIPERTENSIVA — Sem lesão de órgão-alvo", alert:false,
        items:[
    ...
    drugs:[
      ...
      { name:"Captopril", cat:"IECA oral (urgência hipertensiva)", dose:"12,5–25 mg VO — repetir em 30–60 min se necessário (máx 50 mg/episódio)", via:"Via oral (comprimido — NÃO usar sublingual)", ind:"Urgência hipertensiva sem LOA, especialmente pacientes com IECA como anti-hipertensivo prévio", ci:"Gestação (CI absoluta), angioedema, hiperpotassemia grave (K⁺ > 5,5), estenose bilateral de artéria renal", obs:"Onset 30–60 min. Evitar uso sublingual — absorção errática com risco de hipotensão grave. Verificar função renal e K⁺ previamente." },
      { name:"Clonidina", cat:"Agonista α2 central oral (urgência hipertensiva)", dose:"0,1–0,2 mg VO — repetir a cada 1h se necessário (máx 0,6 mg total)", via:"Via oral", ind:"Urgência hipertensiva; síndrome de retirada de clonidina; pacientes com abstinência simpaticomimética", ci:"BAV avançado, hipotensão, uso concomitante de betabloqueador (risco de bradicardia intensa), IC grave", obs:"Sedação frequente. Síndrome de retirada com suspensão abrupta (rebote hipertensivo). Evitar em paciente agitado ou com risco de queda." },
      { name:"Amlodipina", cat:"Bloqueador Ca²⁺ oral (urgência — 24–48h)", dose:"5–10 mg VO em dose única — reavaliação em 24–48h", via:"Via oral", ind:"Urgência hipertensiva — otimização do esquema anti-hipertensivo ao longo de 24–48h; não para controle emergencial imediato", ci:"Hipotensão, insuf. hepática grave (reduzir dose), IC com FE reduzida (relativa)", obs:"Longa meia-vida (30–50h) — não usar como monoterapia para crise aguda. Boa opção para iniciar ou intensificar o esquema ambulatorial após a crise." },
    ],
    antidotes:[
