...
import { AnamneseAuthError, AnamneseConfigError } from "./aiClient.js";
...
export async function transcribeAudio(blob, { authKey, filename = "audio.webm", signal } = {}) {
  ...
  try {
    res = await fetch("/api/transcribe", {
      method: "POST",
      headers: { "x-anamnese-key": authKey || "" },
      body: form,
      signal,
    });
  } catch (e) {
