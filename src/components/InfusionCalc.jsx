...
const DRIPS = [
  { id:"nora",    name:"Noradrenalina",  amount:16,   vol:250, amountUnit:"mg",  factor:1000, doseUnit:"mcg/kg/min", perKg:true,  perMin:true,  range:"0,01–3 mcg/kg/min · alvo PAM ≥ 65",     prep:"4 amp (4 mg/4 mL) + 234 mL SG5%" },
  { id:"adre",    name:"Adrenalina",     amount:6,    vol:100, amountUnit:"mg",  factor:1000, doseUnit:"mcg/kg/min", perKg:true,  perMin:true,  range:"0,01–1 mcg/kg/min",                     prep:"6 amp (1 mg/1 mL) + 94 mL SG5%" },
  { id:"vaso",    name:"Vasopressina",   amount:20,   vol:100, amountUnit:"UI",  factor:1,    doseUnit:"UI/min",     perKg:false, perMin:true,  range:"0,01–0,04 UI/min (dose fixa)",          prep:"1 amp (20 UI) + 100 mL SF 0,9%" },
  { id:"dobu",    name:"Dobutamina",     amount:250,  vol:250, amountUnit:"mg",  factor:1000, doseUnit:"mcg/kg/min", perKg:true,  perMin:true,  range:"2–20 mcg/kg/min",                       prep:"1 amp (250 mg/20 mL) + 230 mL SF/SG" },
  { id:"dopa",    name:"Dopamina",       amount:250,  vol:250, amountUnit:"mg",  factor:1000, doseUnit:"mcg/kg/min", perKg:true,  perMin:true,  range:"2–10 mcg/kg/min",                       prep:"5 amp (50 mg/10 mL) + 200 mL SF/SG" },
  { id:"ntg",     name:"Nitroglicerina", amount:50,   vol:250, amountUnit:"mg",  factor:1000, doseUnit:"mcg/min",    perKg:false, perMin:true,  range:"5–200 mcg/min",                          prep:"1 amp (50 mg/10 mL) + 240 mL SG5% (frasco vidro)" },
  { id:"nps",     name:"Nitroprussiato", amount:50,   vol:250, amountUnit:"mg",  factor:1000, doseUnit:"mcg/kg/min", perKg:true,  perMin:true,  range:"0,25–10 mcg/kg/min · proteger da luz",  prep:"1 amp (50 mg/2 mL) + 248 mL SG5%" },
